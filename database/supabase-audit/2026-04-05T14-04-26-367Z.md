...
- Started at: `2026-04-05T14:04:09.158Z`
- Finished at: `2026-04-05T14:04:26.367Z`
...
### 1. Não foi possível gerar tipos remotos do Supabase
...
- Evidence:
  - `{"method":"linked","status":1,"stderr":"failed to get typescript types: Get \"https://api.supabase.com/v1/projects/pguszziywaeyniluntxw/types/typescript?included_schemas=public\": failed to dial native: dial tcp: lookup api.supabase.com: no such host\nTry rerunning the command with --debug to troubleshoot the error.","error":null}`
...
### 2. Dump remoto do schema indisponível
...
### 4. TypeScript falhou após a auditoria
