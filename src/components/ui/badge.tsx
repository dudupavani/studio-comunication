...
const badgeVariants = cva(
  "inline-flex items-center truncate rounded-md border px-2 py-0.5 gap-1.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:size-[12px]",
  {
    variants: {
      variant: {
        default:
        ...
        green: "border-transparent bg-green-100 text-green-700 space-x-1",
