...
// ✅ Selection + EditorState providers
...
import { EditorStateProvider } from "@/components/design-editor/EditorStateContext";
    ...
    <SelectionProvider manager={manager}>
      <EditorStateProvider>
        <div className="flex flex-col h-screen">
          ...
          <header className="border-b border-gray-200 bg-white p-3 sticky top-0 z-50">
            <PropertiesPanel />
          </header>
          ...
          <div
            ...
            {panel === "templates" && (
              <aside
                ...
                {/* Agora com onClick emitindo o evento global (Canvas mantém EventBridge) */}
                <div className="flex flex-col gap-2">
                  <Button
                    variant="outline"
            ...
            {/* Área redimensionável (Canvas + Camadas) */}
            <ResizablePanelGroup
              ...
              <ResizablePanel defaultSize={75} minSize={40}>
                <section className="flex h-full flex-col">
                  <main className="bg-gray-200 p-3 flex-1 overflow-auto">
                    <Canvas />
                  </main>
                </section>
              </ResizablePanel>
