---
description: Arquitetura geral, boundaries de código e regras que não devem ser quebradas
alwaysApply: true
---
...
- Se a mudança envolve reações, altere primeiro o core e só depois conecte o módulo consumidor.
...
Esses módulos permanecem versionados, mas não fazem parte do produto ativo. Não os use como referência para novas implementações e não proponha mudanças neles sem solicitação explícita.
...
- Infraestrutura de mensagens: `src/lib/messages/*`, `src/app/api/messages/**`
